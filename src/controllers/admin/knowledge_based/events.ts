...
export const VIEW_EVENTS = async (data: any, callback: CallbackFunction) => {
  let sendData = commonController.getSendData();
  try {
    const bodyData = data;
...
export const DELETE_EVENTS = async (data: any, callback: CallbackFunction) => {
  let sendData = commonController.getSendData();
  try {
    const bodyData = data;
...
export const LIST_EVENTS = async (data: any, callback: CallbackFunction) => {
...
export const ADD_EVENTS_IMAGES = async function (
  ...
  try {
    ...
    if (bodyData.infographic_and_did_you_know_imagesid) {
      ...
      const addEvents = await insertOne(
        "infographic_and_did_you_know_images",
        ["image", "report_title", "createddate", "parent_id", "type"],
        [
          bodyData.image,
          bodyData.report_title,
          bodyData.createddate,
...
export const VIEW_EVENTS_IMAGES = async (
  data: any,
  callback: CallbackFunction
) => {
  let sendData = commonController.getSendData();
...
export const DELETE_EVENTS_IMAGES = async (
  data: any,
  callback: CallbackFunction
) => {
  let sendData = commonController.getSendData();
...
export const LIST_EVENTS_IMAGES = async (
  data: any,
  callback: CallbackFunction
) => {
  let sendData = common.commonController.getSendData();
