...
export function bindURL(): void {
  app.get(
    "/admin_master/career_jobs/manage",
    requireAuth,
  ...
  app.get(
    "/admin_master/career_jobs/addEdit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const respData: ResponseData = {
          base_url: BASE_URL ?? "",
  ...
  app.post(
    "/admin_master/career_jobs/delete",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
  ...
  app.post(
    "/admin_master/career_jobs/list/:start/:limit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
