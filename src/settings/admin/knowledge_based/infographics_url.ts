...
export function bindURL(): void {
  app.get(
    "/admin_master/infographics/manage",
    async function (req: Request, res: Response): Promise<void> {
      try {
        ...
        res.render(
          "admin/knowledge_based/infographics/infographics.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err);
  ...
  app.get(
    "/admin_master/infographics/addEdit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const respData: ResponseData = {
          base_url: BASE_URL ?? "",
        ...
        res.render(
          "admin/knowledge_based/infographics/add_infographics.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err);
        ...
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              infographicsController.ADD_INFOGRAPHICS(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/infographics/view",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              const data = req.body;
              data.userData = respData.data;
              infographicsController.VIEW_INFOGRAPHICS(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/infographics/delete",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              const data = req.body;
              data.userData = respData.data;
              infographicsController.DELETE_INFOGRAPHICS(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/infographics/list/:start/:limit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              data.start = start;
              data.limit = limit;
              infographicsController.LIST_INFOGRAPHICS(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
