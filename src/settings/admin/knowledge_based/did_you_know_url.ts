...
export function bindURL(): void {
  app.get(
    "/admin_master/did_you_know/manage",
    async function (req: Request, res: Response): Promise<void> {
      try {
        ...
        res.render(
          "admin/knowledge_based/did_you_know/did_you_know.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err);
  ...
  app.get(
    "/admin_master/did_you_know/addEdit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const respData: ResponseData = {
          base_url: BASE_URL ?? "",
        ...
        res.render(
          "admin/knowledge_based/did_you_know/add_did_you_know.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err);
        ...
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              didYouKnowImageController.ADD_DID_YOU_KNOW_IMAGE(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/did_you_know/view",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              const data = req.body;
              data.userData = respData.data;
              didYouKnowImageController.VIEW_DID_YOU_KNOW_IMAGE(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/did_you_know/delete",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              const data = req.body;
              data.userData = respData.data;
              didYouKnowImageController.DELETE_DID_YOU_KNOW_IMAGE(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/did_you_know/list/:start/:limit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData: any) => {
            if (respData.status !== 200) {
              ...
              data.start = start;
              data.limit = limit;
              didYouKnowImageController.LIST_DID_YOU_KNOW_IMAGE(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
