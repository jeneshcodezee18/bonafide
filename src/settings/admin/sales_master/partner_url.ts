...
export function bindURL(): void {
    app.get("/admin_master/partner_list/manage",
        requireAuth,
    ...
    app.get("/admin_master/partner_list/addEdit", async function (req: Request, res: Response): Promise<void> {
        try {
            const respData: ResponseData = {
                base_url: BASE_URL ?? "",
                title: "Add Partner",
    ...
    app.post("/admin_master/partner/add", async function (req: Request, res: Response): Promise<void> {
        try {
    ...
    app.post("/admin_master/partner/view", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
    ...
    app.post("/admin_master/partner/delete", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
    ...
    app.post("/admin_master/partner/list/:start/:limit", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
