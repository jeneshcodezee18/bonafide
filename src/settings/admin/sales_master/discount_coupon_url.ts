...
export function bindURL(): void {
  app.get(
    "/admin_master/coupon_master/manage",
    requireAuth,
    ...
    async function (req: Request, res: Response): Promise<void> {
      try {
        ...
        res.render(
          "admin/sales_master/discount_coupon/discount_coupon.html",
          respData
        );
      } catch (err: unknown) {
  ...
  app.get(
    "/admin_master/coupon_master/add_filter",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const respData: ResponseData = {
          base_url: BASE_URL ?? "",
        ...
        res.render(
          "admin/sales_master/discount_coupon/add_discount_coupon.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err);
  ...
  app.post(
    "/admin_master/discount_coupon/add",
    async function (req: Request, res: Response): Promise<void> {
      try {
  ...
  app.post(
    "/admin_master/discount_coupon/view",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
  ...
  app.post(
    "/admin_master/discount_coupon/delete",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
  ...
  app.post(
    "/admin_master/all_category/list",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
  ...
  app.post(
    "/admin_master/all_publisher/list",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
          ...
          apiJwtController.DECODE(req, (respData) => {
            if (respData.status !== 200) {
              ...
              const data = req.body;
              data.userData = respData.data;
              salesMasterController.LIST_ALL_PUBLISHER(
                data,
                function (respData) {
                  res.status(respData.status).send(respData);
                }
  ...
  app.post(
    "/admin_master/discount_coupon/list/:start/:limit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
