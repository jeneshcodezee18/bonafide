...
export function bindURL(): void {
  app.get(
    "/admin_master/home_page/our_client_list",
    requireAuth,
  ...
  app.get(
    ...
    async function (req: Request, res: Response): Promise<void> {
      try {
        ...
        res.render(
          "admin/sales_master/our_client/add_our_client.html",
          respData
        );
      } catch (err: unknown) {
        console.error(err); // Log the error for debugging purposes
  ...
  app.post(
    "/admin_master/our_client/delete",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
  ...
  app.post(
    "/admin_master/our_client/list/:start/:limit",
    async function (req: Request, res: Response): Promise<void> {
      try {
        const errors = validationResult(req);
        if (!errors.isEmpty()) {
