...
export function bindURL(): void {
    app.get("/admin_master/home_page/network_of_field_surveyors_list",
        requireAuth,
    ...
    app.get("/admin_master/home_page/network_of_field_surveyors_list_addEdit", async function (req: Request, res: Response): Promise<void> {
        try {
            const respData: ResponseData = {
                base_url: BASE_URL ?? "",
                title: "Add Member",
    ...
    app.post("/admin_master/member/add", async function (req: Request, res: Response): Promise<void> {
        try {
    ...
    app.post("/admin_master/member/view", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
    ...
    app.post("/admin_master/member/delete", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
    ...
    app.post("/admin_master/member/list/:start/:limit", async function (req: Request, res: Response): Promise<void> {
        try {
            const errors = validationResult(req);
            if (!errors.isEmpty()) {
                const respData = commonController.errorValidationResponse(errors);
