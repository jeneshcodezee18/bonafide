      ...
      jQuery.ajax({
        ...
        success: function (response) {
          if (response.err == 1) {
            ...
            formElement.reset();
            window.location.href = BASE_URL + "admin_master/email_template";
          }
        },
      });
    }
