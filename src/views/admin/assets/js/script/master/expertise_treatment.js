...
function pagination(start) {
    ...
    jQuery.ajax({
      type: "POST",
      url: `${BASE_URL}admin/master/expertise_treatment/list/${user_id}/${start}/${limit}`,
      headers: {
...
$("#edit_expertise_treatment").on("submit", function (e) {
    e.preventDefault();
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        jQuery.ajax({ 
          type: "POST",
          url: BASE_URL + "admin/master/expertise_treatment/add",
          headers: {
            authorization: token ? `Bearer ${token}` : "",
          },
          data: {
              ...
              expertise_name_id: $("#expertise_name_id").val(),
  ...
  function view(id) { 
    ...
    jQuery.ajax({
      ...
      url: BASE_URL + "admin/master/expertise_treatment/view",
      data: {
        id: id,
      },
      success: function (response) {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        jQuery.ajax({
          ...
          url: BASE_URL + "admin/master/expertise_treatment/delete",
          data: { 
            id: id,
          },
          success: function (response) {
