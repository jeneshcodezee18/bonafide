...
<html lang="en">
  <head>
    ...
    <title>Blog Detail - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
        ...
        <div class="container">
          <div class="breadcrumbs wow animate__animated animate__fadeIn" data-wow-delay=".0s">
            <ul>
              ...
              <li><a href="#">Blog</a></li>
              <li><a href="#">The Betty Crocker Secret to an Email Marketing Strategy People Enjoy</a></li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="row"> 
            ...
            <div class="col-xl-3 col-lg-4">
              <div class="sidebar-author">
                <div class="box-author"><a href="#"><img src="assets/imgs/page/homepage1/author.png" alt="iori"></a>
                  <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Bessie Cooper</span></a><span class="font-xs color-grey-500 department">November 17, 2025</span><span class="font-xs color-grey-500 icon-read">8 min read</span></div>
                </div>
                ...
                <div class="mt-50"> 
                  ...
                  <ul class="list-number"> 
                    <li> <a href="#">Is making test questions difficult?</a></li>
                    <li> <a href="#">How to write good test questions?</a></li>
                    <li> <a href="#">Start preparing even before you write</a></li>
                    <li> <a href="#">Creating effective open-ended</a></li>
                    <li> <a href="#">Making good descriptive</a></li>
                  </ul>
                </div>
          ...
          <div class="row mt-50">
            <div class="col-lg-4 col-md-6 mb-30 item-article featured wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-blog-grid card-blog-grid-3 hover-up">
                <div class="card-image"><a href="blog-detail.html"><img src="assets/imgs/page/blog/img6.png" alt="iori"></a>
                ...
                <div class="card-info"><a href="blog-detail.html">
                  ...
                  <div class="mb-25 mt-10"><span class="font-xs color-grey-500">November 17, 2025</span><span class="font-xs color-grey-500 icon-read">2 min read</span></div>
            ...
            <div class="col-lg-4 col-md-6 mb-30 item-article featured wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-blog-grid card-blog-grid-3 hover-up">
                <div class="card-image"><a href="blog-detail.html"><img src="assets/imgs/page/blog/img7.png" alt="iori"></a>
            ...
            <div class="col-lg-4 col-md-6 mb-30 item-article other wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-blog-grid card-blog-grid-3 hover-up">
                <div class="card-image"><a href="blog-detail.html"><img src="assets/imgs/page/blog/img8.png" alt="iori"></a>
