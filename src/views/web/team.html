...
<html lang="en">
  <head>
    ...
    <title>Team - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
          ...
          <div class="banner-1">
            <div class="row align-items-center">
              <div class="col-lg-5">
                ...
                <div class="box-author wow animate__animated animate__fadeIn" data-wow-delay=".6s"><a href="#"><img src="assets/imgs/page/team/author.png" alt="iori"></a>
                  <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Bessie Cooper</span></a>
                    <div class="rating d-inline-block"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"></div>
                  </div>
                </div>
              </div>
              <div class="col-lg-7 d-none d-lg-block">
                <div class="box-banner-team">
                  ...
                  <div class="banner-col-1">
                    <div class="img-banner wow animate__animated animate__zoomIn" data-wow-delay=".0s"><img src="assets/imgs/page/team/banner1.png" alt="iori"></div>
                  </div>
                  <div class="banner-col-2">
                    <div class="img-banner wow animate__animated animate__zoomIn" data-wow-delay=".2s"><img src="assets/imgs/page/team/banner2.png" alt="iori"></div>
                    <div class="img-banner hasBorder wow animate__animated animate__zoomIn" data-wow-delay=".4s"><img src="assets/imgs/page/team/banner3.png" alt="iori"></div>
                  </div>
                  <div class="banner-col-3">
                    <div class="img-banner hasBorder2 wow animate__animated animate__zoomIn" data-wow-delay=".6s"><img src="assets/imgs/page/team/banner4.png" alt="iori"></div>
                    <div class="img-banner wow animate__animated animate__zoomIn" data-wow-delay=".8s"><img src="assets/imgs/page/team/banner5.png" alt="iori"></div>
                    <div class="img-banner wow animate__animated animate__zoomIn" data-wow-delay="1s"><img src="assets/imgs/page/team/banner6.png" alt="iori"></div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="section bg-grey-80 pt-70 pb-70">
        <div class="container">
          <ul class="list-partners">
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img src="assets/imgs/page/homepage1/placed.png" alt="iori"></li>
            ...
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".6s"><img src="assets/imgs/page/homepage1/klippa.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".7s"><img src="assets/imgs/page/homepage1/matrix.png" alt="iori"></li>
          </ul>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member1.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member2.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member3.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member4.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member5.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member6.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member7.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member8.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member9.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member10.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member11.png" alt="iori"></div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn">
              <div class="card-member">
                <div class="card-top">
                  <div class="card-image"><img src="assets/imgs/page/team/member12.png" alt="iori"></div>
          ...
          <div class="row mt-50 align-items-center">
            ...
            <div class="col-xl-7 col-lg-12">
              <div class="box-video-business box-images-team">
                <div class="item-video wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img src="assets/imgs/page/team/question1.png" alt="iori"></div>
                <div class="box-image-right">
                  <div class="wow animate__animated animate__fadeIn" data-wow-delay=".2s"><img class="mb-20" src="assets/imgs/page/team/question2.png" alt="iori"></div>
                  <div class="wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img src="assets/imgs/page/team/question3.png" alt="iori"></div>
                </div>
              </div>
            </div>
          </div>
