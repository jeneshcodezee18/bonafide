...
<html lang="en">
  <head>
    ...
    <title>Blog 2 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
          ...
          <div class="box-list-blogs">
                ...
                <div class="item-1">
                  <div class="box-cover-border">
                    <div class="row align-items-center">
                      <div class="col-lg-6"><img class="d-block" src="assets/imgs/page/blog2/img1.png" alt="iori"></div>
                      <div class="col-lg-6">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 mb-30 item-article featured">
                <div class="card-blog-grid card-blog-grid-3 hover-up">
                  <div class="card-image"><a href="blog-detail.html"><img src="assets/imgs/page/blog2/img2.png" alt="iori"></a>
            ...
            <div class="row">
              <div class="col-lg-6 col-md-12 mb-30 item-article featured">
                <div class="card-blog-grid card-blog-grid-3 hover-up">
                  ...
                  <div class="card-info"><a href="blog-detail.html">
                      <h4 class="color-brand-1">22 Strategies for Outdoor &amp; Sporting Goods E-Commerce Retailers in 2025 + Industry Benchmarks</h4></a>
                    <div class="mb-25 mt-10"><span class="font-xs color-grey-500">November 17, 2025</span><span class="font-xs color-grey-500 icon-read">2 min read</span></div>
                    <p class="font-sm color-grey-500 mt-20">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum — semper quis lectus nulla. Interactively transform magnetic growth strategies whereas prospective &quot;outside the box&quot; thinking.</p>
                  </div>
                </div>
