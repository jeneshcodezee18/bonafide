...
<html lang="en">
  <head>
    ...
    <title>Product Detail - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
            ...
            <div class="col-lg-7 text-center mb-30">
              <div class="detail-gallery">
                <div class="product-image-slider">
                  <figure class="border-radius-10"><img src="assets/imgs/page/product/sp1.png" alt="product image"></figure>
                  <figure class="border-radius-10"><img src="assets/imgs/page/product/sp1.png" alt="product image"></figure>
                  <figure class="border-radius-10"><img src="assets/imgs/page/product/sp1.png" alt="product image"></figure>
                  <figure class="border-radius-10"><img src="assets/imgs/page/product/sp1.png" alt="product image"></figure>
                  <figure class="border-radius-10"><img src="assets/imgs/page/product/sp1.png" alt="product image"></figure>
              ...
              <div class="slider-nav-thumbnails">
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn1.png" alt="product image"></div>
                </div>
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn2.png" alt="product image"></div>
                </div>
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn3.png" alt="product image"></div>
                </div>
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn4.png" alt="product image"></div>
                </div>
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn5.png" alt="product image"></div>
                </div>
                <div>
                  <div class="item-thumb"><img src="assets/imgs/page/product/thumn1.png" alt="product image"></div>
                </div>
      ...
      <section class="section mt-70">
        <div class="container">
          <div class="row align-items-center mb-40">
            ...
            <div class="col-lg-5 mb-30">
              <div class="img-reveal"><img src="assets/imgs/page/product/collection1.png" alt="iori"></div>
            </div>
            <div class="col-lg-5 mb-30">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-lg-5 mb-30">
              <div class="img-reveal"><img src="assets/imgs/page/product/collection2.png" alt="iori"></div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="bg-brand-1 box-cover-video">
            <div class="row align-items-center">
              <div class="col-xl-6 col-lg-6">
                <div class="img-reveal"><img class="d-block" src="assets/imgs/page/product/img-video.png" alt="iori"></div>
              </div>
              <div class="col-xl-6 col-lg-6">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/product/delivery.svg" alt="iori"></div></a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/product/secure.svg" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/product/support.svg" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".6s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/product/return.svg" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
