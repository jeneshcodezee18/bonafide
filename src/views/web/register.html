...
<html lang="en">
  <head>
    ...
    <title>Register - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
            ...
            <div class="col-lg-7">
              <div class="box-register">
                ...
                <div class="row wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                  ...
                  <div class="col-lg-12">
                    <div class="form-group mb-25">
                      <p class="font-sm-bold text-center color-grey-500">Or continue with</p>
                    </div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="form-group mb-25"><a class="btn btn-border-80 btn-full" href="#"><img class="d-inline-block align-middle mr-5" src="assets/imgs/page/register/google.svg" alt="iori">Google</a></div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="form-group mb-25"><a class="btn btn-border-80 btn-full" href="#"><img class="d-inline-block align-middle mr-5" src="assets/imgs/page/register/microsoft.svg" alt="iori">Microsoft</a></div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="form-group mb-25"><a class="btn btn-border-80 btn-full" href="#"><img class="d-inline-block align-middle mr-5" src="assets/imgs/page/register/tw.svg" alt="iori">Twitter</a></div>
                  </div>
                  <div class="col-lg-3 col-md-3 col-sm-6 col-6">
                    <div class="form-group mb-25"><a class="btn btn-border-80 btn-full" href="#"><img class="d-inline-block align-middle mr-5" src="assets/imgs/page/register/fb.svg" alt="iori">Facebook</a></div>
                  </div>
