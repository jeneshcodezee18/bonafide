...
<html lang="en">
  <head>
    ...
    <title>Homepage 10 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
          ...
          <div class="container position-relative">
            <div class="row align-items-center">
              <div class="col-lg-6 mb-30">
                <h1 class="color-brand-1 mb-50 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">We Are<br class="d-none d-lg-block">Leading Digital<br class="d-none d-lg-block">University</h1>
                <p class="font-md color-grey-500 mb-40 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Enable highly motivating non-cash micropayments and offer<br class="d-none d-lg-block">in-demand prepaid solutions – with a single connection.</p>
                <div class="box-button mb-50 wow animate__animated animate__fadeInUp" data-wow-delay=".4s"><a class="btn btn-brand-1 hover-up" href="#">Download App</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
              ...
              <div class="col-lg-6 mb-30">
                <div class="text-center wow animate__animated animate__fadeIn"><img src="assets/imgs/page/homepage10/banner.png" alt="iori"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section mt-50 mb-50 bg-brand-1 pt-100 pb-100 bg-explore">
        <div class="container">
          <div class="text-center"><span class="font-xl-bold color-white text-uppercase wow animate__animated animate__fadeInUp" data-wow-delay=".0s">explore network</span>
            <h2 class="color-brand-2 mb-60 mt-15 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Ready to capture every<br class="d-none d-lg-block">wonderful moment</h2>
          </div>
          <div class="mt-30 mb-60">
            <ul class="list-buttons list-buttons-circle nav nav-tabs" role="tablist">
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a class="active" href="#tab-explore-1" data-bs-toggle="tab" role="tab" aria-controls="tab-explore-1" aria-selected="true">Digital Cameras</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".2s"><a href="#tab-explore-2" data-bs-toggle="tab" role="tab" aria-controls="tab-explore-2" aria-selected="true">Mirrorless Camera</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".4s"><a href="#tab-explore-3" data-bs-toggle="tab" role="tab" aria-controls="tab-explore-3" aria-selected="true">Camera Flashes</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".5s"><a href="#tab-explore-4" data-bs-toggle="tab" role="tab" aria-controls="tab-explore-4" aria-selected="true">Travel Camera</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".6s"><a href="#tab-explore-5" data-bs-toggle="tab" role="tab" aria-controls="tab-explore-5" aria-selected="true">Instant Camera</a></li>
            </ul>
            <div class="tab-content wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              ...
              <div class="tab-pane fade" id="tab-explore-2" role="tabpanel" aria-labelledby="tab-explore-2">
                <div class="box-tab-32">
                  <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-5"><img class="bd-rd16" src="assets/imgs/page/blog2/img1.png" alt="iori"></div>
                    <div class="col-xl-6 col-lg-7">
                      <div class="box-business-tab"><span class="btn btn-tag">Business</span>
                        <h3 class="color-brand-1 mt-10 mb-15">Integrate with over 1,000 project management apps</h3>
                        <p class="font-md color-grey-400">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit laborum — semper quis lectus nulla. Interactively transform magnetic growth strategies whereas prospective &quot;outside the box&quot; thinking.</p>
      ...
      <div class="border-bottom mt-50"></div>
      <section class="section mt-50 mb-50">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5"><span class="btn btn-tag wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Branding</span>
              <h3 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Build your brand and reach out to social followers</h3>
              <p class="font-md color-grey-400 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Sharing content online allows you to craft an online persona that reflects your personal values and professional skills. Even if you only use social media occasionally, what you create, share or react to feeds into this public narrative. How you conduct yourself online is now just as important as your behavior offline especially when it comes to your digital marketing career.</p>
              ...
              <div class="mt-40 text-start wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a class="btn btn-brand-1 hover-up" href="#">Download App</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
                  <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                  </svg></a></div>
            </div>
            <div class="col-lg-7">
              <div class="box-imgs-branding text-end">
                <div class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img class="img-round-top" src="assets/imgs/page/homepage10/img.png" alt="iori"></div>
                <div class="img-branding-small wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img class="img-round-top-small" src="assets/imgs/page/homepage10/img2.png" alt="iori"></div>
              </div>
            </div>
          </div>
        </div>
      </section>
      <section class="section mt-50 bg-7 bg-plan pt-110 pb-110">
        <div class="container">
          <div class="row align-items-end">
            ...
            <div class="col-lg-4 col-md-4 text-md-end text-start wow animate__animated animate__fadeIn" data-wow-delay=".4s"><a class="btn btn-default font-sm-bold pl-0">Compare plans
                <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                </svg></a></div>
          </div>
          <div class="row mt-50">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeIn" data-wow-delay=".6s">
              <div class="card-plan hover-up">
                <div class="card-image-plan">
                  <div class="icon-plan bg-3"><img src="assets/imgs/page/homepage2/creation.png" alt="iori"></div>
                  <div class="info-plan">
        ...
        <div class="container">
          <div class="row align-items-start">
            <div class="col-lg-4 text-start pt-50">
              <div class="row">
                <div class="col-md-9"><img class="mb-30" src="assets/imgs/page/homepage2/customer.png" alt="iori"></div>
              </div>
              <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">What our custommers are saying</h2>
              <p class="font-lg color-gray-500 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">Hear from our users who have saved thousands on their Startup and SaaS solution spend.</p>
              <div class="mt-20"><a class="btn btn-default font-sm-bold pl-0 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">View All
                  <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                  </svg></a></div>
            </div>
            <div class="col-lg-8">
              <div class="row">
                <div class="col-lg-6 col-md-6">
                  <div class="mb-30 mt-50 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                    <div class="card-testimonial-grid">
                      <div class="box-author mb-10"><a href="#"><img src="assets/imgs/page/homepage1/author.png" alt="iori"></a>
                      ...
                      <div class="card-bottom-info"><span class="font-xs color-grey-500 date-post">29 November 2025</span>
                  ...
                  <div class="mb-30 testimonial-warning wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    <div class="card-testimonial-grid">
                      <div class="box-author mb-10"><a href="#"><img src="assets/imgs/page/homepage2/author2.png" alt="iori"></a>
                        <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Guy Hawkins</span></a><span class="font-xs color-grey-500 department">Bank of America</span></div>
                      </div>
                      <p class="font-md color-grey-500">Access the same project through five different dynamic views: a kanban board, Gantt chart, spreadsheet, calendar or simple task list. When team members can choose the work style that suits them best, productivity and engagement skyrocket. Maecenas lobortis risus.</p>
                      <div class="card-bottom-info"><span class="font-xs color-grey-500 date-post">29 November 2025</span>
                ...
                <div class="col-lg-6 col-md-6">
                  <div class="mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                    <div class="card-testimonial-grid">
                      <div class="box-author mb-10"><a href="#"><img src="assets/imgs/page/homepage2/author3.png" alt="iori"></a>
                        <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Guy Hawkins</span></a><span class="font-xs color-grey-500 department">Bank of America</span></div>
                      </div>
                      <p class="font-md color-grey-500">Access the same project through five different dynamic views: a kanban board, Gantt chart, spreadsheet, calendar or simple task list. When team members can choose the work style that suits them best, productivity and engagement skyrocket. Maecenas lobortis risus.</p>
                      <div class="card-bottom-info"><span class="font-xs color-grey-500 date-post">29 November 2025</span>
                  ...
                  <div class="mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    <div class="card-testimonial-grid">
                      <div class="box-author mb-10"><a href="#"><img src="assets/imgs/page/homepage2/author4.png" alt="iori"></a>
                        <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Guy Hawkins</span></a><span class="font-xs color-grey-500 department">Bank of America</span></div>
                      </div>
                      <p class="font-md color-grey-500">Access the same project through five different dynamic views: a kanban board, Gantt chart, spreadsheet, calendar or simple task list. When team members can choose the work style that suits them best, productivity and engagement skyrocket. Maecenas lobortis risus.</p>
                      <div class="card-bottom-info"><span class="font-xs color-grey-500 date-post">29 November 2025</span>
          ...
          <div class="bg-brand-1 box-cover-video">
            <div class="row align-items-center">
              <div class="col-xl-6 col-lg-6">
                <div class="img-reveal"><img class="d-block" src="assets/imgs/page/homepage1/img-video.png" alt="iori"></div>
              </div>
              <div class="col-xl-6 col-lg-6">
                <div class="box-info-video"><span class="btn btn-tag wow animate__animated animate__fadeInUp" data-wow-delay=".0s">Business</span>
                  ...
                  <div class="box-button-video wow animate__animated animate__fadeInUp" data-wow-delay=".3s"><a class="btn btn-play font-sm-bold popup-youtube hover-up" href="https://www.youtube.com/watch?v=sVPYIRF9RCQ">Play Video</a></div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row align-items-center">
              <div class="col-lg-5 col-md-12">
                <div class="box-image-newsletter">
                  <div class="wow animate__animated animate__zoomIn" data-wow-delay=".0s"><img class="img-main" src="assets/imgs/template/newsletter_img.png" alt="iori"></div>
