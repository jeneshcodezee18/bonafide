...
<html lang="en">
  <head>
    ...
    <title>Homepage 12 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
      <section class="section banner-12">
        ...
        <div class="container text-center">
          <div class="row mt-150">
            <div class="col-xl-8 col-lg-10 m-auto"><span class="font-md color-grey-400 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Think. Creative. Solve</span>
              <h1 class="color-brand-1 mb-25 mt-10 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Innovative Solution to Move Your Business Forward</h1>
              <p class="font-md color-grey-500 mb-25 wow animate__animated animate__fadeIn" data-wow-delay=".4s">Collaborate, plan projects and manage resources with powerful features that your whole team<br class="d-none d-lg-block">can use.  The latest news, tips and advice to help you run your business with less fuss.</p>
              <div class="wow animate__animated animate__fadeIn" data-wow-delay=".6s"><a href="#"><img class="mr-10" src="assets/imgs/template/appstore.png" alt="iori"></a><a href="#"><img src="assets/imgs/template/google-play.png" alt="iori"></a></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div class="section home12-logos">
        <div class="container">
          <ul class="lists-logo">
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img src="assets/imgs/page/homepage12/placed.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".1s"><img src="assets/imgs/page/homepage12/cuebiq.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".2s"><img src="assets/imgs/page/homepage12/factual.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".3s"><img src="assets/imgs/page/homepage12/placeiq.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img src="assets/imgs/page/homepage12/airmeet.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".5s"><img src="assets/imgs/page/homepage12/spen.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".6s"><img src="assets/imgs/page/homepage12/klippa.png" alt="iori"></li>
            <li class="wow animate__animated animate__fadeIn" data-wow-delay=".7s"><img src="assets/imgs/page/homepage12/matrixian.png" alt="iori"></li>
          </ul>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-6 mb-20">
              <h2 class="color-brand-1 mb-0 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Crafting human connection through digital experience</h2>
            </div>
            <div class="col-lg-6 mb-20">
              <p class="color-grey-500 font-md mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p><a class="btn btn-default p-0 font-sm-bold hover-up" href="#">Contact Us
          ...
          <div class="row mt-45">
            <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-human">
                <div class="card-image mb-15"><img src="assets/imgs/page/homepage12/human1.png" alt="iori"></div>
                <div class="card-info mb-30">
                  <h4 class="color-brand-1 mt-15 mb-10">Cross Platform</h4>
                  <p class="font-sm color-grey-500">Discover powerful features to boost your productivit. You are always welcome to visit our little den.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-human">
                ...
                <div class="card-image mb-15"><img src="assets/imgs/page/homepage12/human2.png" alt="iori">
                </div>
              </div>
            </div>
            <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-human">
                <div class="card-image mb-15"><img src="assets/imgs/page/homepage12/human3.png" alt="iori"></div>
                <div class="card-info mb-30">
                  <h4 class="color-brand-1 mt-15 mb-10">Cross Platform</h4>
                  <p class="font-sm color-grey-500">Discover powerful features to boost your productivit. You are always welcome to visit our little den.</p>
                </div>
                ...
                <div class="col-lg-6">
                  <div class="box-cover-pd">
                    <div class="box-image-rd-30">
                      <div class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img class="w-100" src="assets/imgs/page/homepage12/business.png" alt="iori"></div>
                      <h4 class="color-brand-1 lbl-on-top wow animate__animated animate__fadeIn" data-wow-delay=".4s">IORI Business Platform</h4>
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="box-cover-pd-2">
                    <h2 class="color-brand-1 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">How to grow your<br class="d-none d-lg-block">business fast</h2>
        ...
        <div class="container">
          <div class="box-create-account bg-4">
            <div class="row align-items-center">
              <div class="col-lg-6"><span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".0s">Take the control</span>
                <h2 class="color-brand-1 mb-20 mt-10 wow animate__animated animate__fadeIn" data-wow-delay=".2s">Create a free<br class="d-none d-lg-block">account today.</h2>
                <p class="font-md color-grey-500 mb-50 wow animate__animated animate__fadeIn" data-wow-delay=".4s">Access advanced order types including limit, market, stop limit and dollar cost averaging. Track your total asset holdings, values and equity over time. Monitor markets, manage your portfolio, and trade crypto on the go.</p>
                <div class="row">
                  <div class="col-lg-6 col-sm-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                    <div class="box-image-bg-60"><img class="d-block" src="assets/imgs/page/homepage3/personal.svg" alt="iori"></div>
                    <h6 class="color-brand-1 mb-15">Personal</h6>
                    <p class="font-xs color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque. Praesent vulputate justo dictum nisl faucibus, eu feugiat ex pretium. Duis sed mauris at nisi egestas suscipit eget eu enim.</p>
                  </div>
                  <div class="col-lg-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
                    <div class="box-image-bg-60"><img class="d-block" src="assets/imgs/page/homepage3/building.svg" alt="iori"></div>
                    <h6 class="color-brand-1 mb-15">Personal</h6>
                    <p class="font-xs color-grey-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus malesuada felis eget finibus placerat. Aliquam sit amet vestibulum felis, sit amet porta neque. Praesent vulputate justo dictum nisl faucibus, eu feugiat ex pretium. Duis sed mauris at nisi egestas suscipit eget eu enim.</p>
                  </div>
                </div>
              ...
              <div class="col-lg-6 position-relative mb-30 box-right">
                <div class="box-image-account"><img class="d-block" src="assets/imgs/page/homepage12/account.png" alt="iori"></div>
                <div class="cardNumber bg-2">
                  <div class="card-head"><span class="count">469</span><span>k</span></div>
                  <div class="card-description">Social followers</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-lg-4 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-support">
                ...
                <div class="card-info">
                  ...
                  <p class="font-md color-grey-500 mb-15">Share updates instantly within our project management software, and get the entire team collaborating</p><a class="btn btn-default pl-0 font-sm-bold hover-up" href="#">Learn More
                    <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg></a>
                </div>
