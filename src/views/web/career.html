...
<html lang="en">
  <head>
    ...
    <title>Career - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
      <section class="section mt-90">
        <div class="container">
          ...
          <div class="box-video mt-70"><img src="assets/imgs/page/career/img-video.png" alt="iori">
            <div class="image-1 shape-1"><img src="assets/imgs/page/career/certify.png" alt="iori"></div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          ...
          <div class="row mt-65">
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/homepage1/free.svg" alt="iori"></div></a></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/homepage1/cross.png" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/homepage2/identity.png" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
              <div class="card-small card-small-2">
                <div class="card-image"><a href="#">
                    <div class="box-image"><img src="assets/imgs/page/career/persuasion.png" alt="iori"></div></a></div>
                <div class="card-info"><a href="#">
          ...
          <div class="row mt-50">
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer1.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer2.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer3.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer4.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer5.png" alt="iori"></div>
                <div class="card-info">
                  <h4 class="color-brand-1 mb-10"><a class="color-brand-1" href="job-detail.html">Manage budgets and resources</a></h4>
                  <p class="font-md color-grey-500 mb-5">Seamless importing and round-tripping of Microsoft Project plans, Excel files &amp; CSV files.</p>
                  <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
            ...
            <div class="col-lg-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-offer card-we-do hover-up">
                <div class="card-image"><img src="assets/imgs/page/homepage4/offer6.png" alt="iori"></div>
                <div class="card-info">
