...
<html lang="en">
  <head>
    ...
    <link href="assets/css/style.css?v=6.0.0" rel="stylesheet">
    <title>Homepage 7 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
      ...
      <div class="container">
        <div class="main-header">
          <div class="header-left">
            <div class="header-logo"><a class="d-flex" href="index.html"><img alt="Ecom" src="assets/imgs/page/homepage6/logo.svg"></a></div>
                ...
                <ul class="main-menu">
                  <li class="has-children"><a class="active" href="index.html">Home</a>
                    <div class="sub-menu two-col"><a class="btn-homepage" href="#"><span>
                      ...
                      <p class="font-xs color-grey-300">Beautiful and Truly Unique Pre-Built Frontend Homepages Easily complete website for your business. New designs will be continuously added. Click to view the demo.</p>
                      <ul class="menu-inner">
                        ...
                        <li><a href="index-10.html">
                            <svg class="w-6 h-6 icon-16" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                            </svg>Homepage - 10</a></li>
                        <li><a href="index-11.html">
                            <svg class="w-6 h-6 icon-16" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                            </svg>Homepage - 11</a></li>
                        <li><a href="index-12.html">
                            <svg class="w-6 h-6 icon-16" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                            </svg>Homepage - 12</a></li>
                      </ul>
                    </div>
                  </li>
    ...
    <div class="mobile-header-active mobile-header-wrapper-style perfect-scrollbar">
      <div class="mobile-header-wrapper-inner">
        <div class="mobile-header-content-area">
          <div class="mobile-logo"><a class="d-flex" href="index.html"><img alt="IORI" src="assets/imgs/template/logo.svg"></a></div>
          ...
          <div class="perfect-scroll">
                ...
                <div class="tab-pane fade" id="tab-notification" role="tabpanel" aria-labelledby="tab-notification">
                  ...
                  <div class="notifications-item">
                    <div class="item-notify">
                      ...
                      <div class="item-info">
                        <p class="color-grey-500 font-xs"><strong class="font-xs-bold">Steven Job</strong>like started a poll in your post “How to be a good trader in 2025”</p>
                      </div>
            ...
            <div class="site-copyright color-grey-400 mt-0">
              ...
              <div class="mb-0">Copyright 2025 &copy; IORI - Marketplace Template.<br>Designed by<a href="http://alithemes.com" target="_blank">&nbsp; AliThemes</a></div>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="box-radius-32 ml-minus-85 mr-minus-85">
            <div class="row align-items-center h-100">
              <div class="col-xl-6">
                <div class="box-banner-left-home7"><span class="title-line line-48 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Think. Creative. Solve</span>
                  <h1 class="color-brand-1 mb-20 mt-5 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">We take care of your business to grow</h1>
                  <div class="row">
                    <div class="col-lg-10">
                      <p class="font-md color-grey-500 mb-25 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Collaborate, plan projects and manage resources with powerful features that your whole team can use.  The latest news, tips and advice to help you run your business with less fuss.</p>
                    </div>
                  </div>
                  <div class="box-join-now">
                    <div class="box-form-join wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                      <form action="#">
                        ...
                        <button class="btn btn-join">Join Now
                  ...
                  <div class="box-joined wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    <div class="box-authors"><span class="item-author"><img src="assets/imgs/page/homepage7/author1.png" alt="iori"></span><span class="item-author"><img src="assets/imgs/page/homepage7/author2.png" alt="iori"></span><span class="item-author"><img src="assets/imgs/page/homepage7/author3.png" alt="iori"></span><span class="item-author"><span class="text-num-author font-md-bold color-brand-1">+2k</span></span></div><span class="join-thousands font-sm color-grey-400 d-inline-block">Join thousands of users in using the<a class="font-sm-bold color-brand-1" href="#">iori platform!</a></span>
                  </div>
                </div>
              </div>
              <div class="col-xl-6 d-none d-xl-block h-100">
                <div class="box-banner-7">
                  <div class="banner-7-img-1 scroll-1 wow animate__animated animate__fadeIn" data-wow-delay=".0s"><img src="assets/imgs/page/homepage7/banner1.png" alt="iori"><img src="assets/imgs/page/homepage7/banner1-2.png" alt="iori"><img src="assets/imgs/page/homepage7/banner1-3.png" alt="iori"></div>
                  <div class="banner-7-img-2 scroll-2 wow animate__animated animate__fadeIn" data-wow-delay=".4s"><img src="assets/imgs/page/homepage7/banner2.png" alt="iori"><img src="assets/imgs/page/homepage7/banner2-2.png" alt="iori"><img src="assets/imgs/page/homepage7/banner2-3.png" alt="iori"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row mt-50 align-items-end">
            <div class="col-xl-4 col-lg-4 mb-30">
              <h4 class="color-brand-1 mb-5 wow animate__animated animate__fadeInUp">See why we are<br class="d-none d-lg-block">trusted the world over</h4>
              <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 mb-30">
              <ul class="list-partners list-partners-2 text-start">
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".s"><img src="assets/imgs/page/homepage1/placed.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".1s"><img src="assets/imgs/page/homepage1/cuebiq.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".2s"><img src="assets/imgs/page/homepage1/factual.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".3s"><img src="assets/imgs/page/homepage1/placeiq.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".4s"><img src="assets/imgs/page/homepage1/airmeet.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".1s"><img src="assets/imgs/page/homepage1/spen.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".2s"><img src="assets/imgs/page/homepage1/klippa.png" alt="iori"></li>
                <li class="wow animate__animated animate__fadeInUp" data-wow-delay=".3s"><img src="assets/imgs/page/homepage1/matrix.png" alt="iori"></li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div class="row align-items-start">
            <div class="col-xl-6 col-lg-6 mb-30">
              <div class="card-radius-32">
                <div class="card-info">
                  <h3 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Financial Management</h3>
                  <p class="font-md color-grey-500 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Track, manage, and control your expenses. The only financial management tool you’ll ever need.</p>
                  <div class="text-center wow animate__animated animate__fadeInUp" data-wow-delay=".s"><a href="#"><img class="mr-10" src="assets/imgs/template/appstore.png" alt="iori"></a><a href="#"><img src="assets/imgs/template/google-play.png" alt="iori"></a></div>
                </div>
                <div class="card-image wow animate__animated animate__fadeIn" data-wow-delay=".s"><img src="assets/imgs/page/homepage7/img-financial.png" alt="iori"></div>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 mb-30">
              <div class="card-radius-32 bg-4">
                <div class="card-info">
                  <h3 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Automated Platform</h3>
                  <p class="font-md color-grey-500 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".s">Synchronize and automate all your business in the cloud. Save time and effort, enjoy great vacations.</p>
                  <div class="mt-0"><a class="btn btn-brand-1-small" href="#">Get Started Now
                      <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                      </svg></a></div>
                </div>
                <div class="card-image wow animate__animated animate__fadeIn" data-wow-delay=".s"><img src="assets/imgs/page/homepage7/automated.png" alt="iori"></div>
              </div>
            </div>
                  ...
                  <div class="col-lg-6">
                    <div class="box-cover-pd">
                      <div class="box-image-rd-30">
                        <div class="img-reveal"><img class="w-100" src="assets/imgs/page/homepage7/img.png" alt="iori"></div>
                        <h4 class="color-brand-1 lbl-on-top wow animate__animated animate__fadeInUp" data-wow-delay=".s">IORI Business Platform</h4>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="box-cover-pd-2">
                      <h2 class="color-brand-1 mb-30l">How to grow your<br class="d-none d-lg-block">business fast</h2>
      ...
      <section class="section mt-50">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5 mb-30"><span class="title-line line-48 wow animate__animated animate__fadeInUp">Automatic Tools</span>
              <h2 class="color-brand-1 mt-10 mb-15 wow animate__animated animate__fadeInUp">Business can also be simple</h2>
              <p class="font-md color-grey-400 wow animate__animated animate__fadeInUp">Access advanced order types including limit, market, stop limit and dollar cost averaging. Track your total asset holdings, values and equity over time. Monitor markets, manage your portfolio, and trade crypto on the go.</p>
              <div class="mt-40">
              ...
              <div class="mt-40 text-start wow animate__animated animate__fadeInUp"><a class="btn btn-brand-1 hover-up" href="#">Download App</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
                  <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                  </svg></a></div>
            </div>
            <div class="col-lg-7 text-center position-relative mb-30"><img src="assets/imgs/page/homepage7/img-2.png" alt="iori">
              <div class="shape-1 box-image-4"><img src="assets/imgs/page/homepage7/chart.png" alt="iori"></div>
              <div class="box-number-business shape-3">
                <div class="cardNumber bg-white">
                  <h3><span class="count">25</span><span>k+</span></h3>
            ...
            <div class="col-lg-4 mb-30 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
              <div class="card-guide bg-4">
                ...
                <div class="card-info">
                  ...
                  <div class="mt-10"><a class="btn btn-default font-sm-bold pl-0">Learn more
                      <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                      </svg></a></div>
                </div>
          ...
          <div class="row align-items-start">
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-team mb-30">
                <div class="card-image"><img src="assets/imgs/page/about/team1.png" alt="iori"></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-team mb-30">
                <div class="card-image"><img src="assets/imgs/page/about/team2.png" alt="iori"></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-team mb-30">
                <div class="card-image"><img src="assets/imgs/page/about/team3.png" alt="iori"></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".s">
              <div class="card-team mb-30">
                <div class="card-image"><img src="assets/imgs/page/team/team1.png" alt="iori"></div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 text-center">
              <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp">Choose The Best Plan</h2>
              ...
              <ul class="tabs-plan change-price-plan" role="tablist">
                <li class="wow animate__animated animate__fadeInUp"><a class="active" href="#" data-type="monthly">Monthly</a></li>
                <li class="wow animate__animated animate__fadeInUp"><a href="#" data-type="yearly">Yearly</a></li>
              </ul>
            </div>
          </div>
          <div class="row mt-50">
            <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
              <div class="card-plan-style-2 hover-up">
                <div class="card-plan">
                  <div class="card-image-plan">
                    <div class="icon-plan bg-1"><img src="assets/imgs/page/homepage1/standard.svg" alt="iori"></div>
                    <div class="info-plan">
                      <h4 class="color-brand-1">Standard</h4>
                      <p class="font-md color-grey-400">Advanced project</p>
                    </div>
                  </div>
                  <div class="box-day-trial"><span class="font-lg-bold color-brand-1 text-price-standard">$29</span><span class="font-md color-grey-500 text-type-standard">- user / month</span><br><span class="font-xs color-grey-500">Billed annually</span></div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
              <div class="card-plan-style-2 hover-up">
                <div class="card-plan">
                  <div class="card-image-plan">
                    <div class="icon-plan bg-2"><img src="assets/imgs/page/homepage1/business.svg" alt="iori"></div>
                    <div class="info-plan">
                      <h4 class="color-brand-1">Business</h4>
                      <p class="font-md color-grey-400">Protect for testing</p>
                    </div>
                  </div>
                  <div class="box-day-trial"><span class="font-lg-bold color-brand-1 text-price-business">$99</span><span class="font-md color-grey-500 text-type-business">- user / month</span><br><span class="font-xs color-grey-500">Billed annually</span></div>
                  <div class="mt-20"><a class="btn btn-brand-1-full hover-up" href="#">Get Started
                      <svg class="w-6 h-6 icon-16 ml-10" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                      </svg></a></div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6 wow animate__animated animate__fadeInUp" data-wow-delay=".6s">
              <div class="card-plan-style-2 hover-up">
                <div class="card-plan">
                  <div class="card-image-plan">
                    <div class="icon-plan bg-3"><img src="assets/imgs/page/homepage1/enterprise.svg" alt="iori"></div>
                    <div class="info-plan">
                      <h4 class="color-brand-1">Enterprise</h4>
                      <p class="font-md color-grey-400">Protect for testing</p>
                    </div>
                  </div>
                  <div class="box-day-trial"><span class="font-lg-bold color-brand-1 text-price-enterprise">$299</span><span class="font-md color-grey-500 text-type-enterprise">- user / month</span><br><span class="font-xs color-grey-500">One-time pay</span></div>
                  <div class="mt-20"><a class="btn btn-brand-1-full hover-up" href="#">Get Started
                      <svg class="w-6 h-6 icon-16 ml-10" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                      </svg></a></div>
      ...
      <section class="section mt-50 bg-grey-60">
        <div class="container">
          <div class="pt-120 pb-120">
            <h2 class="color-brand-1 wow animate__animated animate__fadeInUp">What our loving users are<br class="d-none d-lg-block">saying about us</h2>
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="card-review">
                        <div class="card-info">
                          <div class="rating-review"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"></div>
                          <h5 class="color-grey-800 mb-20">Access the same project through five different dynamic views: a kanban board, Gantt chart, spreadsheet, calendar or simple task list. When team members can choose the work style that suits them best, productivity and engagement skyrocket. Maecenas lobortis risus.</h5>
                          <div class="box-author"><a href="#"><img src="assets/imgs/page/homepage7/author4.png" alt="iori"></a>
                    ...
                    <div class="swiper-slide">
                      <div class="card-review">
                        <div class="card-info">
                          <div class="rating-review"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"><img src="assets/imgs/page/homepage7/star.png" alt="iori"></div>
                          <h5 class="color-grey-800 mb-20">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Mauris ac quam sem. Fusce convallis tortor non erat rutrum facilisis. Integer id sem et neque mattis fringilla. Sed ut suscipit justo, in lacinia leo. Suspendisse potenti. Morbi in ornare tellus.</h5>
                          <div class="box-author"><a href="#"><img src="assets/imgs/page/homepage7/author5.png" alt="iori"></a>
                            <div class="author-info"><a href="#"><span class="font-md-bold color-brand-1 author-name">Guy Hawkins</span></a><span class="font-xs color-grey-500 department">Bank of America</span></div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="card-blog-grid card-blog-grid-2 hover-up">
                ...
                <div class="card-info"><a href="blog-detail.html">
                  ...
                  <div class="mt-20 d-flex align-items-center border-top pt-20"><a class="btn btn-border-brand-1 mr-15" href="blog.html">Technology</a><span class="date-post font-xs color-grey-300 mr-15">
                      ...
                      </svg>29 May 2025</span><span class="time-read font-xs color-grey-300">
                      <svg class="w-6 h-6 icon-16" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3 width-20">
              <div class="mb-10"><img src="assets/imgs/template/logo.svg" alt="iori"></div>
              <p class="font-md mb-20 color-grey-400">4517 Washington Ave.<br class="d-none d-lg-block">Manchester, Kentucky 39495</p>
            ...
            <div class="col-lg-3 width-23">
              ...
              <div>
                ...
                <div class="mt-20"><a class="mr-10" href="#"><img src="assets/imgs/template/appstore.png" alt="iori"></a><a href="#"><img src="assets/imgs/template/google-play.png" alt="iori"></a></div>
                <p class="font-sm color-grey-400 mt-20 mb-10">Secured Payment Gateways</p><img src="assets/imgs/template/payment-method.png" alt="iori">
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="footer-bottom">
            <div class="row">
              ...
              <div class="col-lg-6 col-md-12 text-center text-lg-end"><span class="color-grey-300 font-md">©Iori Official 2025. All right reversed.</span></div>
            </div>
          </div>
        </div>
      </div>
