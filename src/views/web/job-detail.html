...
<html lang="en">
  <head>
    ...
    <title>Job Detail - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
      <section class="section pt-50 pb-100">
        <div class="container">
          <div class="box-image-detail"><img class="bd-rd16 d-block" src="assets/imgs/page/job-detail/img-job.png" alt="iori"></div>
                ...
                <div class="box-detail-content"> 
                  <div class="row align-items-center"> 
                    <div class="col-lg-8 col-md-8 col-sm-12 col-12 mb-30">
                      <h3 class="color-brand-1 mb-10 mt-0">Business Development Manager and Financial Services</h3><span class="date-post font-xs color-grey-300"> 
                        <svg class="w-6 h-6 icon-16" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-12 text-start text-md-end mb-30"> <a class="btn btn-brand-1 btn-apply" href="#"> 
                  ...
                  <div class="box-info-bottom"> 
                    <div class="row align-items-center"> 
                      <div class="col-lg-6 col-md-6 col-sm-5 col-12 mb-30"> <a class="btn btn-brand-1 btn-apply" href="#"> 
                          <svg class="w-6 h-6 icon-18 mr-10" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                          </svg>Appy Now</a></div>
                      <div class="col-lg-6 col-md-6 col-sm-7 col-12 text-start text-sm-end mb-30"> <a class="btn btn-tag mb-10" href="#">App</a><a class="btn btn-tag ml-10 mb-10" href="#">Digital</a><a class="btn btn-tag ml-10 mb-10" href="#">Marketing</a></div>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-8 col-md-8">
              ...
              <p class="font-lg color-gray-500">We regularly recruit at many positions.<br class="d-none d-lg-block">See related jobs here</p>
            </div>
          ...
          <div class="row mt-50">
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/page/job-detail/ui.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/page/job-detail/java.png" alt="iori"></div>
                <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
              <div class="card-offer hover-up">
                <div class="card-image"><img src="assets/imgs/page/job-detail/senior.png" alt="iori"></div>
                <div class="card-info">
          ...
          <div class="row mt-50">
            <div class="col-xl-6 col-lg-5">
              <div class="box-images-project">
                ...
                <p class="color-grey-500 mb-15 wow animate__animated animate__fadeIn">Necessary to deliver white glove, fully managed campaigns that surpass industry benchmarks.Take your career to next level. Apply to our team and see what we can do together. You’re good enough.</p>
                <p class="color-grey-500">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature Id pro doctus mediocrem erroribus, diam nostro sed cu. Ea pri graeco tritani partiendo. Omittantur No tale choro fastidii his, pri cu epicuri perpetua. Enim dictas omittantur et duo, vocent lucilius quaestio mea ex. Ex illum officiis id.</p>
                <div class="box-button text-start mt-40 wow animate__animated animate__fadeIn"><a class="btn btn-brand-1 hover-up" href="#">Download App</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
                    <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg></a></div>
              </div>
