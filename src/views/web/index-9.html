...
<html lang="en">
  <head>
    ...
    <title>Homepage 9 - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
          ...
          <div class="box-swiper">
            <div class="swiper-container swiper-notify">
              <div class="swiper-wrapper">
                <div class="swiper-slide"><span class="d-inline-block font-sm color-brand-2">Cyber Monday: Save big on the Creative Cloud All Apps plan for individuals through 2 Dec</span></div>
                <div class="swiper-slide"><span class="d-inline-block font-sm color-brand-2">Students and teachers save a massive 71% on Creative Cloud All Apps</span></div>
                <div class="swiper-slide"><span class="d-inline-block font-sm color-brand-2">Black Friday and Cyber Monday 2025 Deals for Motion Designers, grab it now!</span></div>
              </div>
            </div>
          </div>
        </div>
    ...
    <main class="main">
        ...
        <div class="box-banner-home9">
          <div class="container position-relative">
            <div class="row align-items-center">
              <div class="col-lg-7 mb-30"><span class="title-line line-48 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">Get Started</span>
                <h2 class="color-brand-1 mb-15 mt-0 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">Promotes your business<br class="d-none d-lg-block">no matter what you do</h2>
                <p class="font-md color-grey-500 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">Collaborate, plan projects and manage resources with powerful features that<br class="d-none d-lg-block">your whole team can use.  The latest news, tips and advice to help you run your<br class="d-none d-lg-block">business with less fuss.</p>
                <div class="mt-10 wow animate__animated animate__fadeInUp" data-wow-delay=".6s"><a class="btn btn-play btn-play-white font-sm-bold popup-youtube" href="https://www.youtube.com/watch?v=sVPYIRF9RCQ">Play video</a></div>
              </div>
              <div class="col-lg-5 mb-30 wow animate__animated animate__fadeInLeft" data-wow-delay=".0s">
                <div class="box-joined">
                  <div class="box-authors"><span class="item-author"><img src="assets/imgs/page/homepage7/author1.png" alt="iori"></span><span class="item-author"><img src="assets/imgs/page/homepage7/author2.png" alt="iori"></span><span class="item-author"><img src="assets/imgs/page/homepage7/author3.png" alt="iori"></span><span class="item-author"><span class="text-num-author font-md-bold color-brand-1 bg-grey-60">+2k</span></span></div><span class="join-thousands font-sm color-grey-400 d-inline-block">Join thousands of users in using the<a class="font-sm-bold color-brand-1" href="#">iori platform!</a></span>
                </div>
              </div>
            </div>
            <div class="box-image-banner-9 wow animate__animated animate__fadeIn"><img src="assets/imgs/page/homepage9/banner.png" alt="iori"></div>
            <div class="box-ticks">
              <div class="row">
                <div class="col-lg-4 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s"><span class="item-tick color-brand-1 font-xl-bold">Unlimited design & dev requests</span></div>
                <div class="col-lg-4 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".2s"><span class="item-tick color-brand-1 font-xl-bold">No Card. No Contract. Cancel anytime</span></div>
                <div class="col-lg-4 mb-20 wow animate__animated animate__fadeIn" data-wow-delay=".4s"><span class="item-tick color-brand-1 font-xl-bold">Monthly flat-rate. Support 24/7</span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section class="section mt-50">
        <div class="container">
          <div class="text-center">
            <h2 class="color-brand-1 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Crafting human connection through<br class="d-none d-lg-block">digital experience</h2>
            <p class="color-grey-500 font-md wow animate__animated animate__fadeIn" data-wow-delay=".2s"> Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir<br class="d-none d-lg-block">craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
          </div>
          <div class="row align-items-start mt-50">
            <div class="col-xl-6 col-lg-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-radius-32 bg-2">
                <div class="card-info text-start">
                  <h3 class="color-brand-1 mb-20">Social Media Platform</h3>
                  <p class="font-md color-grey-500 mb-20">Manage your media channels professionally and efficiently. Real-time and automatic reporting system.</p>
                  <div class="text-start"><a href="#"><img class="mr-10" src="assets/imgs/template/appstore.png" alt="iori"></a><a href="#"><img src="assets/imgs/template/google-play.png" alt="iori"></a></div>
                </div>
                <div class="card-image mb-10"><img src="assets/imgs/page/homepage9/img.png" alt="iori"></div>
              </div>
            </div>
            <div class="col-xl-6 col-lg-6 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".2s">
              <div class="card-radius-32 bg-11">
                <div class="card-info text-start">
                  <h3 class="color-brand-1 mb-20">Automated Platform</h3>
                  <p class="font-md color-grey-500 mb-20">Synchronize and automate all your business in the cloud. Save time and effort, enjoy great vacations.</p>
                  <div class="mt-0"><a class="btn btn-brand-1-small" href="#">Get Started Now
                      <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                      </svg></a></div>
                </div>
                <div class="card-image image-automated"><img class="d-block" src="assets/imgs/page/homepage9/img2.png" alt="iori"></div>
              </div>
            </div>
            <div class="col-xl-12 mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
              <div class="card-radius-32 bg-1">
                <div class="row align-items-center">
                  <div class="col-lg-6">
                    <div class="box-cover-pd box-cover-pd-3 pt-30 pb-30 mb-30"><span class="title-line line-48">Automatic Tools</span>
                      <h2 class="color-brand-1 mt-10 mb-15">Business can also<br class="d-none d-lg-block">be simple</h2>
                      ...
                      <div class="mt-40 text-start"><a class="btn btn-brand-1 hover-up" href="help.html">Help Center</a><a class="btn btn-default font-sm-bold hover-up" href="#">Learn More
                          <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                          </svg></a></div>
                    </div>
                  ...
                  <div class="col-lg-6 text-center position-relative">
                    <div class="box-circle-image"><img class="d-block m-auto" src="assets/imgs/page/homepage9/img3.png" alt="iori">
                      <div class="shape-1 box-image-4"><img src="assets/imgs/page/homepage9/testimonial.png" alt="iori"></div>
        ...
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-12 text-center">
              <h2 class="color-brand-1 mb-20 wow animate__animated animate__fadeInUp" data-wow-delay=".0s"> Take your social media marketing<br class="d-none d-lg-block">prowess to the next level</h2>
            </div>
          </div>
          <div class="text-center mt-25 mb-65 wow animate__animated animate__fadeIn" data-wow-delay=".3s">
            <div class="box-social-media">
              <ul class="tabs-plan change-media" role="tablist">
                <li><a class="active" href="#" data-type="personal">Personal</a></li>
                <li><a href="#" data-type="enterprise">Enterprise</a></li>
              </ul>
            </div>
          </div>
          <div class="row mt-50">
            <div class="col-lg-4 col-md-6 social-media enterprise">
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage1/cross2.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Cross-Platform</h4>
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 bg-5 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage1/cross.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Social Media</h4>
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 bg-2 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage2/identity.png" alt="iori"></div>
                  <div class="card-info">
            ...
            <div class="col-lg-4 col-md-6 social-media enterprise">
              <div class="card-offer-style-2 bg-1 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                <div class="card-offer hover-up">
                  ...
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Customer Service</h4>
                    <p class="font-md color-grey-500 mb-15">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 bg-1 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage1/cross4.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Customer Service</h4>
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 bg-7 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage1/cross5.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Social advertising</h4>
                    <p class="font-md color-grey-500 mb-15">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
            ...
            <div class="col-lg-4 col-md-6 social-media enterprise">
              <div class="card-offer-style-2 bg-4 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage2/creation.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Content creation</h4>
                    <p class="font-md color-grey-500 mb-15">Discover powerful features to boost your productivit. You are always welcome to visit our little den. Professional in teir craft! All products were super amazing with strong attension to details, comps and overall vibe.</p>
                    <div class="box-button-offer"><a class="btn btn-default font-sm-bold pl-0 color-brand-1">Learn More
                        <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
            ...
            <div class="col-lg-4 col-md-6 social-media personal">
              <div class="card-offer-style-2 bg-4 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                <div class="card-offer hover-up">
                  <div class="card-image"><img src="assets/imgs/page/homepage2/creation.png" alt="iori"></div>
                  <div class="card-info">
                    <h4 class="color-brand-1 mb-15">Content creation</h4>
      ...
      <section class="section mt-100">
        <div class="container">
          <div class="text-center">
            <h3 class="color-brand-1 mb-15 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Loved By Developers, Trusted By Enterprises</h3>
          ...
          <div class="mt-30 wow animate__animated animate__fadeIn" data-wow-delay=".0s">
            <div class="box-swiper pager-style-2">
              <div class="swiper-container swiper-group-8">
                <div class="swiper-wrapper">
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/placed.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/cuebiq.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/factual.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/placeiq.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/airmeet.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/spen.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/klippa.png" alt="iori"></div>
                  <div class="swiper-slide"><img src="assets/imgs/page/homepage1/matrix.png" alt="iori"></div>
                </div>
      ...
      <section class="section mt-120">
        <div class="container">
          <div class="box-radius-32-style-2">
            <div class="row align-items-center">
              <div class="col-lg-7"><span class="title-line line-48 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Get Started</span>
                <h1 class="color-brand-1 mb-20 mt-10 wow animate__animated animate__fadeIn" data-wow-delay=".2s"> Start for free<br class="d-none d-lg-block">Pay as you Grow</h1>
                ...
                <div class="mt-30">
                  <h5 class="color-brand-1 wow animate__animated animate__fadeIn" data-wow-delay=".0s"> Available on</h5>
                </div>
                <div class="box-button mt-20 wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a class="btn-app mb-15 hover-up" href="#"><img src="assets/imgs/template/appstore-btn.png" alt="iori"></a><a class="btn-app mb-15 hover-up" href="#"><img src="assets/imgs/template/google-play-btn.png" alt="iori"></a><a class="btn btn-default mb-15 pl-10 font-sm-bold hover-up" href="#">Learn More
                    <svg class="w-6 h-6 icon-16 ml-5" fill="none" stroke="currentColor" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                    </svg></a></div>
              </div>
              <div class="col-lg-5 text-start position-relative"><span class="arrow-down-banner shape-1"></span><span class="arrow-right-banner shape-2"></span>
                <div class="box-signup wow animate__animated animate__fadeIn" data-wow-delay=".0s">
                  ...
                  <div class="form-group mb-15">
                    <button class="btn btn-brand-1-full" type="submit">Sing In</button>
                  </div>
                  <div class="form-group mb-25"><a class="btn btn-border btn-full signin-google" href="#"><img src="assets/imgs/page/homepage4/google.png" alt="iori">Sign in with Google</a></div>
                  <div class="text-already text-center"><span class="font-xs color-grey-400">Already have an account?</span><a class="color-brand-1 font-xs" href="#">Sign in</a><span class="font-xs color-grey-400">.</span></div>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <div class="col-lg-6 wow animate__animated animate__fadeInUp" data-wow-delay=".0s">
                    <div class="accordion-item">
                      <h5 class="accordion-header" id="headingOne">
                        <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Where is my order? Quisque molestie</button>
                      </h5>
