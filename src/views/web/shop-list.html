...
<html lang="en">
  <head>
    ...
    <title>Shop List - Multipurpose Startup & SaaS Template</title>
  </head>
  <body>
    ...
    <main class="main">
      <section class="section mt-30">
        <div class="container"> 
          <div class="box-banner-shop-list bg-4">
            <div class="row align-items-center"> 
              <div class="col-lg-6 text-center">
                <div class="box-banner-image bg-10"><img class="mw-90" src="assets/imgs/page/shop-list/banner.png" alt="iori"></div>
              </div>
              <div class="col-lg-6">
                <div class="box-info-banner-shop-list"> 
                  <h6 class="color-danger mb-10">HOT DEAL</h6>
                  <h2 class="color-gray-800 mb-20">Leather Canvas Camera Bag Vintage</h2>
                  ...
                  <p class="mb-30 font-md color-grey-500">We're lively, not corporate. We have the energy and boldness of a startup and the expertise and pragmatism of a scale-up. All in one place.</p>
                  ...
                  <div class="mt-60 d-flex align-item-center box-share-banner"> <strong class="font-xs-bold color-brand-1 mr-20">Share</strong>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-12 text-center">
              <h2 class="color-brand-1 mb-20">Latest Products</h2>
            </div>
          </div>
          <div class="mt-30 mb-60">
            <ul class="list-buttons list-buttons-round">
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".0s"><a class="active" href="#" data-type="all">Digital Cameras</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".1s"><a href="#" data-type="featured">Mirrorless Camera</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".2s"><a href="#" data-type="company">Camera Flashes</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".3s"><a href="#" data-type="product-news">Travel Camera</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".4s"><a href="#" data-type="customer-stories">Instant Camera</a></li>
              <li class="wow animate__animated animate__fadeIn" data-wow-delay=".5s"><a href="#" data-type="guides">Accessories</a></li>
            </ul>
          </div>
          <div class="row mt-50">
            ...
            <div class="col-xl-6 col-lg-12">
              <div class="card-product card-product-list">
                <div class="card-image"><a href="product-detail.html"><img src="assets/imgs/page/shop/sp6.png" alt="iori"></a></div>
                <div class="card-info"><a href="product-detail.html">
                    <h6 class="color-grey-900 mb-10">Ricoh GR III Digital Compact Camera, 24mp</h6></a>
                  <div class="d-flex align-items-center mb-20">
                    <div class="rating"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star.svg" alt="iori"><img src="assets/imgs/template/icons/star-gray.svg" alt="iori"><span class="color-grey-200 font-xs ml-10 d-inline-block align-middle">(84 rates)</span></div>
                    <div class="price"><span class="text-price">$22.51</span></div>
                  </div>
                  <p class="color-grey-300 font-xs">Full-frame Mirrorless Interchangeable Lens Camera with 28-70mm Zoom Lens Kit</p>
                  <ul class="list-dots mt-15">
                    <li class="font-xs">Fe 28-70Mm F/3.5-5.6 Oss Lens</li>
                    <li class="font-xs">Np-Fw50 Lithium-Ion Rechargeable Battery</li>
                    <li class="font-xs">Multi-Interface Shoe Cover</li>
                  </ul>
                </div>
              </div>
            </div>
